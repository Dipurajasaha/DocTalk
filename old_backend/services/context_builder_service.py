    ...
    async def build_context(
        ...
        *,
        ...
        if role == "doctor" and not consultation_id:
            raise HTTPException(status_code=status.HTTP_422_UNPROCESSABLE_ENTITY, detail="consultation_id is required for doctor context retrieval")
    ...
    def _build_context_text(
        ...
        *,
        ...
        for source_type in ("consultation", "prescription", "xray", "ocr", "unknown"):
            ...
            if not bucket:
                continue
            section_order.append(source_type)
