...
export default function HospitalDashboard() {
  ...
  const sidebarTabs = [
    ...
    { id: 'reports', label: 'Symptom Reports' },
    { id: 'submit-report', label: 'New Report' },
    { id: 'news', label: 'News' },
    { id: 'analysis', label: 'Analysis' },
  ];

  return (
    <div className="hospital-app-wrapper">
      {/* Top Navigation Bar */}
      <nav className="hospital-top-navbar">
        <div className="hospital-nav-logo">
      ...
      <div className="hospital-layout">
        ...
        <div className="hospital-sidebar">
          <div className="hospital-sidebar-name">{dashboard?.hospital_name || session?.user_id}</div>
          ...
          <div className="hospital-nav">
            {sidebarTabs.map((tab) => (
              <button
                ...
                onClick={() => {
                  setActiveTab(tab.id);
                  if (tab.id === 'submit-report') setShowReportForm(true);
                  else { setShowReportForm(false); setShowNewsForm(false); }
                }}
              >
                {tab.label}
              </button>
