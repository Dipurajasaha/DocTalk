      ...
      <main className="home-main">
        ...
        <section id="features" className="features-section">
          ...
          <div className="features-grid">
            ...
            <FeatureCard delay={240} icon={<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="11" cy="11" r="8"/><path d="M21 21l-4.35-4.35"/></svg>} title="X-Ray Analysis" desc="Upload medical imaging for AI-assisted analysis. Get structured reports highlighting potential areas of concern instantly." />
