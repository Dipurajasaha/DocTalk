...
def parse_document_query(text: str) -> DocumentQueryIntent | None:
    ...
    if "blood" in text:
        ...
        # No specific entity for general report unless requested, or we can append "report"
        # Since Stage 9 validation expects empty list for latest report, I won't append "report"
    else:
        return None
